...
public:
    ...
    virtual void DrawLine(int32_t x0, int32_t y0, int32_t x1, int32_t y1, color_t color) = 0;
    virtual void DrawThickLine(int32_t x0, int32_t y0, int32_t x1, int32_t y1, int32_t thickness, color_t color) = 0;
    virtual void DrawCircle(int32_t x, int32_t y, int32_t radius, color_t color) = 0;
    virtual void DrawRect(int32_t x, int32_t y, int32_t width, int32_t height, color_t color) = 0;

...
const Color ButtonStyle::kColorOnPress{ColorFromRGBA(0x5680c2)};
...
void ButtonStyle::Apply(Widget* widget, RenderTexture* texture) {
...
void MenuButtonStyle::Apply(Widget* widget, RenderTexture* texture) {
    assert(widget  != nullptr);
    assert(texture != nullptr);
